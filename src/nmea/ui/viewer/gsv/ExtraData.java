...
{
  private GPSChartPanel chartPanel = new GPSChartPanel();
  private GSVExtraData  extraDataPanel = new GSVExtraData();
  ...
  private void jbInit()
  {
    ...
    this.setPreferredSize(new Dimension(GPSChartPanel.CHART_WIDTH, 600));
