...
//      System.out.println("NMEA:" + str);
      ...
      public void newSpotData(List<SpotLine> spotLines, GeoPos pos)
      {
        spotPlot = null;
        if (pos != null)
          spotPlot = new GeoPoint(pos.lat, pos.lng);
        repaint();
      }
    });
...
//  chartPanel.setWidthFromChart(nLat, sLat, wLong, eLong);
  ...
  GeoPoint plot = null, spotPlot = null;
...
//    gr.fillOval(pt.x - 5, pt.y - 5, 10, 10);
    ...
    if (spotPlot != null)
    {
      Point pt = chartPanel.getPanelPoint(spotPlot);
      //    gr.fillOval(pt.x - 5, pt.y - 5, 10, 10);
      Color lightColor = ChartColor.YELLOW;
      Color darkColor  = ChartColor.DARK_RED; 
      drawGlossyCircularBall(g2d, pt, 5, lightColor, darkColor, 0.9f);
    }
  }
