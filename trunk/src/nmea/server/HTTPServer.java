...
//              System.out.println("............... Reading " + f.getAbsolutePath());
    ...
    try { Utils.playSound(this.getClass().getResource("saberup.wav")); } catch (Exception ex) { ex.printStackTrace(); }
  }
...
//  str += ("Device prefix:" + currentPrefix + "\n");
  ...
  private String generateTWS()
  {
    ...
    {
      double tws = 0d; 
      try { tws = ((Speed)NMEAContext.getInstance().getCache().get(NMEADataCache.TWS)).getValue(); } catch (Exception ignore) {}
